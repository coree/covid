...
# !JOSPEH'S NOTE: change the name of the data.07062021 to the lastest date (data.?????)
diff --new-line-format="" --unchanged-line-format="" data/ids/all_pmids.txt data.07062021/ids/all_pmids.txt > data/ids/pmids.txt
