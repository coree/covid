...
cp -r /mnt/bdsk/joseph/oger_biobert/output/brat/data/LitCovid /mnt/bdsk/joseph/oger_biobert/output/brat/data/LitCovid.$(date +'%d%m%Y')
cp data/merged/brat/* /mnt/bdsk/joseph/oger_biobert/output/brat/data/LitCovid
...
cp data/public/litcovid19.bioc.json /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.bioc/litcovid19.$(date +'%d%m%Y').bioc.json
tar -czvf /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.bioc.json.tgz /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.bioc
...
cat data/public/litcovid19.tsv >> /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.tsv
tar -czvf /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.tsv.tgz /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.tsv
...
cp data/public/txt/* /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.txt
tar -czvf /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.txt.tgz /mnt/bdsk/joseph/oger_biobert/output/clfiles/LitCovid/litcovid19.txt
